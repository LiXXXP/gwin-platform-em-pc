  ...
  <div>
    ...
    >
      <el-form-item label="操作者">
        <el-input :placeholder="props.lookTagDetail.createName" disabled></el-input>
      </el-form-item>
      <el-form-item label="更新时间">
        <el-input :placeholder="props.lookTagDetail.updateAt" disabled></el-input>
      </el-form-item>
...
interface Props {
  lookTagDetail: lookTagDetailParam
}
...
const state: any = reactive({
  ruleForm: {
    tagCategory: props.lookTagDetail.tagCategory || '',
    tagName: props.lookTagDetail.tagName || '',
    memo: props.lookTagDetail.memo || ''
  },
  rules: {
    tagCategory: [
      {
...
watchEffect(() => {
  ;({ ...state.ruleForm } = { ...props.lookTagDetail })
})
 ...
 * 编辑标签
 */
const TagMaintenance = async () => {
  const param = {
    userId: getUserId(),
    id: props.lookTagDetail.id,
    ...state.ruleForm
  }
  await TagsApi.tagMaintenance(param)
  ElMessage({
    message: '修改成功',
    type: 'success'
  })
